---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/coin-margined-futures/market-data/rest-api/Kline-Candlestick-Data
api_type: Market Data
updated_at: 2026-01-15T23:38:29.334457
---
...
## 接口描述[​](/docs/zh-CN/derivatives/coin-margined-futures/market-data/rest-api/Kline-Candlestick-Data#接口描述 "接口描述的直接链接")

每根K线的开盘时间可视为唯一ID

## HTTP请求[​](/docs/zh-CN/derivatives/coin-margined-futures/market-data/rest-api/Kline-Candlestick-Data#http请求 "HTTP请求的直接链接")
...
## HTTP请求[​](/docs/zh-CN/derivatives/coin-margined-futures/market-data/rest-api/Kline-Candlestick-Data#http请求-1 "HTTP请求的直接链接")
...
## 请求权重[​](/docs/zh-CN/derivatives/coin-margined-futures/market-data/rest-api/Kline-Candlestick-Data#请求权重 "请求权重的直接链接")
...
## 请求参数[​](/docs/zh-CN/derivatives/coin-margined-futures/market-data/rest-api/Kline-Candlestick-Data#请求参数 "请求参数的直接链接")
