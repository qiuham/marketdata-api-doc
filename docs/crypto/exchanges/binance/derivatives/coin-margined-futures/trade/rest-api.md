---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/coin-margined-futures/trade/rest-api
api_type: Trading
updated_at: 2026-01-15T23:39:31.095177
---
...
## 接口描述[​](/docs/zh-CN/derivatives/coin-margined-futures/trade/rest-api#接口描述 "接口描述的直接链接")

下单(TRADE)

## HTTP请求[​](/docs/zh-CN/derivatives/coin-margined-futures/trade/rest-api#http请求 "HTTP请求的直接链接")

POST `/dapi/v1/order`

## 请求权重[​](/docs/zh-CN/derivatives/coin-margined-futures/trade/rest-api#请求权重 "请求权重的直接链接")

1min order rate limit(X-MBX-ORDER-COUNT-1M)为1  
IP rate limit(x-mbx-used-weight-1m)为0

## 请求参数[​](/docs/zh-CN/derivatives/coin-margined-futures/trade/rest-api#请求参数 "请求参数的直接链接")
...
quantity| DECIMAL| NO| 以合约数量计量的下单数量，使用`closePosition`不支持此参数。  
...
## 响应示例[​](/docs/zh-CN/derivatives/coin-margined-futures/trade/rest-api#响应示例 "响应示例的直接链接")
