---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/coin-margined-futures/websocket-market-streams/Mark-Price-Kline-Candlestick-Streams
api_type: WebSocket
updated_at: 2026-01-15T23:40:51.510141
---
...
## 数据流描述[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/Mark-Price-Kline-Candlestick-Streams#数据流描述 "数据流描述的直接链接")
...
## Stream Name[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/Mark-Price-Kline-Candlestick-Streams#stream-name "Stream Name的直接链接")

`<symbol>@markPriceKline_<interval>`

例如: btcusd_200626@markPriceKline_1m

## 更新速度[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/Mark-Price-Kline-Candlestick-Streams#更新速度 "更新速度的直接链接")

**250ms**

## 响应示例[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/Mark-Price-Kline-Candlestick-Streams#响应示例 "响应示例的直接链接")
