---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/coin-margined-futures/websocket-market-streams/All-Market-Tickers-Streams
api_type: WebSocket
updated_at: 2026-01-15T23:40:32.183901
---
...
## 数据流描述[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/All-Market-Tickers-Streams#数据流描述 "数据流描述的直接链接")

所有symbol 24小时完整ticker信息.需要注意的是,只有发生变化的ticker更新才会被推送。

## Stream Name[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/All-Market-Tickers-Streams#stream-name "Stream Name的直接链接")

`!ticker@arr`

## 更新速度[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/All-Market-Tickers-Streams#更新速度 "更新速度的直接链接")

**1000ms**

## 响应示例[​](/docs/zh-CN/derivatives/coin-margined-futures/websocket-market-streams/All-Market-Tickers-Streams#响应示例 "响应示例的直接链接")
