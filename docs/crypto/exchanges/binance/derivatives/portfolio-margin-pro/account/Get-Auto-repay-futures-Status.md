---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/portfolio-margin-pro/account/Get-Auto-repay-futures-Status
api_type: Account
updated_at: 2026-01-15T23:44:05.207230
---
...
## 接口描述[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Get-Auto-repay-futures-Status#接口描述 "接口描述的直接链接")

查询自动清还合约负余额模式

## HTTP请求[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Get-Auto-repay-futures-Status#http请求 "HTTP请求的直接链接")

GET `/sapi/v1/portfolio/repay-futures-switch`

## 请求权重(IP)[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Get-Auto-repay-futures-Status#请求权重ip "请求权重\(IP\)的直接链接")

**30**

## 请求参数[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Get-Auto-repay-futures-Status#请求参数 "请求参数的直接链接")
...
## 响应示例[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Get-Auto-repay-futures-Status#响应示例 "响应示例的直接链接")
