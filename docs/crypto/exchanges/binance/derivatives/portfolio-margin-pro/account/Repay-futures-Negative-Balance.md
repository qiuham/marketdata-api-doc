---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/portfolio-margin-pro/account/Repay-futures-Negative-Balance
api_type: Account
updated_at: 2026-01-15T23:44:20.313276
---
...
## 接口描述[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Repay-futures-Negative-Balance#接口描述 "接口描述的直接链接")

清还合约负余额

## HTTP请求[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Repay-futures-Negative-Balance#http请求 "HTTP请求的直接链接")

POST `/sapi/v1/portfolio/repay-futures-negative-balance`

## 请求权重(IP)[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Repay-futures-Negative-Balance#请求权重ip "请求权重\(IP\)的直接链接")

**1500**

## 请求参数[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Repay-futures-Negative-Balance#请求参数 "请求参数的直接链接")
...
## 响应示例[​](/docs/zh-CN/derivatives/portfolio-margin-pro/account/Repay-futures-Negative-Balance#响应示例 "响应示例的直接链接")
