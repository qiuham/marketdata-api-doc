---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/usds-margined-futures/account/rest-api/Get-Futures-Trade-Download-Link-by-Id
api_type: Trading
updated_at: 2026-01-15T23:46:23.950947
---
...
## 接口描述[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Get-Futures-Trade-Download-Link-by-Id#接口描述 "接口描述的直接链接")

通过下载Id获取合约交易历史下载链接

## HTTP请求[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Get-Futures-Trade-Download-Link-by-Id#http请求 "HTTP请求的直接链接")

GET `/fapi/v1/trade/asyn/id`

## 请求权重[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Get-Futures-Trade-Download-Link-by-Id#请求权重 "请求权重的直接链接")

**10**

## 请求参数[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Get-Futures-Trade-Download-Link-by-Id#请求参数 "请求参数的直接链接")
...
## 响应示例[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Get-Futures-Trade-Download-Link-by-Id#响应示例 "响应示例的直接链接")
