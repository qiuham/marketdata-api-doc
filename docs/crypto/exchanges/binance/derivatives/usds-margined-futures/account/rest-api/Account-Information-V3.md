...
api_type: Account
updated_at: 2026-01-15T23:46:14.112591
---
...
## 接口描述[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Account-Information-V3#接口描述 "接口描述的直接链接")

现有账户信息。 用户在单资产模式和多资产模式下会看到不同结果，响应部分的注释解释了两种模式下的不同。

## HTTP请求[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Account-Information-V3#http请求 "HTTP请求的直接链接")

GET `/fapi/v3/account`

## 请求权重[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Account-Information-V3#请求权重 "请求权重的直接链接")

**5**

## 请求参数[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Account-Information-V3#请求参数 "请求参数的直接链接")
...
## 响应示例[​](/docs/zh-CN/derivatives/usds-margined-futures/account/rest-api/Account-Information-V3#响应示例 "响应示例的直接链接")
