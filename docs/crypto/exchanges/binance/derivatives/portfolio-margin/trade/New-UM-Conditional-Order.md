---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/portfolio-margin/trade/New-UM-Conditional-Order
api_type: Trading
updated_at: 2026-01-15T23:45:36.878793
---
...
## 接口描述[​](/docs/zh-CN/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#接口描述 "接口描述的直接链接")

UM条件单下单

## HTTP请求[​](/docs/zh-CN/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#http请求 "HTTP请求的直接链接")

POST `/papi/v1/um/conditional/order`

## 请求权重[​](/docs/zh-CN/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#请求权重 "请求权重的直接链接")

**1**

## 请求参数[​](/docs/zh-CN/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#请求参数 "请求参数的直接链接")
...
## 响应示例[​](/docs/zh-CN/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#响应示例 "响应示例的直接链接")
