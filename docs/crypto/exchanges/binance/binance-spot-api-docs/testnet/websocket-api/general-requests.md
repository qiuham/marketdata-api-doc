---
exchange: binance
source_url: https://developers.binance.com/docs/binance-spot-api-docs/testnet/websocket-api/general-requests
api_type: WebSocket
updated_at: 2026-01-15T23:36:55.775891
---
...
### Test connectivity[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/general-requests#test-connectivity "Test connectivity的直接链接")
...
### Check server time[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/general-requests#check-server-time "Check server time的直接链接")
...
### Exchange information[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/general-requests#exchange-information "Exchange information的直接链接")
...
Notes:
  ...
  * [Available Permissions](/docs/zh-CN/binance-spot-api-docs/testnet/enums#account-and-symbol-permissions)
