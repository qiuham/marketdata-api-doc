---
exchange: binance
source_url: https://developers.binance.com/docs/binance-spot-api-docs/testnet/websocket-api/authentication-requests
api_type: WebSocket
updated_at: 2026-01-15T23:36:48.902982
---
...
### Log in with API key (SIGNED)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/authentication-requests#log-in-with-api-key-signed "Log in with API key \(SIGNED\)的直接链接")
...
### Query session status[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/authentication-requests#query-session-status "Query session status的直接链接")
...
### Log out of the session[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/authentication-requests#log-out-of-the-session "Log out of the session的直接链接")
