---
exchange: binance
source_url: https://developers.binance.com/docs/binance-spot-api-docs/testnet/rest-api/request-security
api_type: REST
updated_at: 2026-01-15T23:36:42.908021
---

# Request Security

* Each endpoint has a security type indicating required API key permissions, shown next to the endpoint name (e.g., [New order (TRADE)](/docs/binance-spot-api-docs/testnet/rest-api/request-security#place-new-order-trade)).
  * If unspecified, the security type is `NONE`.
  * Except for `NONE`, all endpoints with a security type are considered `SIGNED` requests (i.e. including a `signature`), except for [listenKey management](/docs/binance-spot-api-docs/testnet/rest-api/request-security#user-data-stream-requests).
...
### SIGNED Endpoint security[​](/docs/binance-spot-api-docs/testnet/rest-api/request-security#signed-endpoint-security "Direct link to SIGNED Endpoint security")

  * `SIGNED` endpoints require an additional parameter, `signature`, to be sent in the `query string` or `request body`.



#### Signature Case Sensitivity[​](/docs/binance-spot-api-docs/testnet/rest-api/request-security#signature-case-sensitivity "Direct link to Signature Case Sensitivity")
...
Please consult [SIGNED request example (HMAC)](/docs/binance-spot-api-docs/testnet/rest-api/request-security#hmac-keys), [SIGNED request example (RSA)](/docs/binance-spot-api-docs/testnet/rest-api/request-security#rsa-keys), and [SIGNED request example (Ed25519)](/docs/binance-spot-api-docs/testnet/rest-api/request-security#ed25519-keys) on how to compute signature, depending on which API key type you are using.

### Timing security[​](/docs/binance-spot-api-docs/testnet/rest-api/request-security#timing-security "Direct link to Timing security")

  * `SIGNED` requests also require a `timestamp` parameter which should be the current timestamp either in milliseconds or microseconds. (See [General API Information](/docs/binance-spot-api-docs/testnet/rest-api/request-security#general-api-information))
...
### SIGNED Endpoint Examples for POST /api/v3/order[​](/docs/binance-spot-api-docs/testnet/rest-api/request-security#signed-endpoint-examples-for-post-apiv3order "Direct link to SIGNED Endpoint Examples for POST /api/v3/order")

#### HMAC Keys[​](/docs/binance-spot-api-docs/testnet/rest-api/request-security#hmac-keys "Direct link to HMAC Keys")
...
#### RSA Keys[​](/docs/binance-spot-api-docs/testnet/rest-api/request-security#rsa-keys "Direct link to RSA Keys")
...
#### Ed25519 Keys[​](/docs/binance-spot-api-docs/testnet/rest-api/request-security#ed25519-keys "Direct link to Ed25519 Keys")
...
* Each endpoint has a security type indicating required API key permissions, shown next to the endpoint name (e.g., [New order (TRADE)](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#place-new-order-trade)).
  * If unspecified, the security type is `NONE`.
  * Except for `NONE`, all endpoints with a security type are considered `SIGNED` requests (i.e. including a `signature`), except for [listenKey management](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#user-data-stream-requests).
  * Secure endpoints require a valid API key to be specified and authenticated. 
    * API keys can be created on the [SPOT Test Network](https://testnet.binance.vision) upon logging in with your Github account.
    * **Both API key and secret key are sensitive.** Never share them with anyone. If you notice unusual activity in your account, immediately revoke all the keys and contact Binance support.
  * API keys can be configured to allow access only to certain types of secure endpoints. 
...
### SIGNED Endpoint security[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#signed-endpoint-security "SIGNED Endpoint security的直接链接")

  * `SIGNED` endpoints require an additional parameter, `signature`, to be sent in the `query string` or `request body`.



#### Signature Case Sensitivity[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#signature-case-sensitivity "Signature Case Sensitivity的直接链接")
...
Please consult [SIGNED request example (HMAC)](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#hmac-keys), [SIGNED request example (RSA)](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#rsa-keys), and [SIGNED request example (Ed25519)](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#ed25519-keys) on how to compute signature, depending on which API key type you are using.

### Timing security[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#timing-security "Timing security的直接链接")

  * `SIGNED` requests also require a `timestamp` parameter which should be the current timestamp either in milliseconds or microseconds. (See [General API Information](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#general-api-information))
  * An additional optional parameter, `recvWindow`, specifies for how long the request stays valid and may only be specified in milliseconds. 
    * `recvWindow` supports up to three decimal places of precision (e.g., 6000.346) so that microseconds may be specified.
    * If `recvWindow` is not sent, **it defaults to 5000 milliseconds**.
    * Maximum `recvWindow` is 60000 milliseconds.
...
### SIGNED Endpoint Examples for POST /api/v3/order[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#signed-endpoint-examples-for-post-apiv3order "SIGNED Endpoint Examples for POST /api/v3/order的直接链接")

#### HMAC Keys[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#hmac-keys "HMAC Keys的直接链接")
...
#### RSA Keys[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#rsa-keys "RSA Keys的直接链接")
...
#### Ed25519 Keys[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/request-security#ed25519-keys "Ed25519 Keys的直接链接")
