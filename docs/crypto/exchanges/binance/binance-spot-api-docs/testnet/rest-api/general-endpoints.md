---
exchange: binance
source_url: https://developers.binance.com/docs/binance-spot-api-docs/testnet/rest-api/general-endpoints
api_type: REST
updated_at: 2026-01-15T23:36:36.841761
---

# General endpoints

### Test connectivity[​](/docs/binance-spot-api-docs/testnet/rest-api/general-endpoints#test-connectivity "Direct link to Test connectivity")
...
### Check server time[​](/docs/binance-spot-api-docs/testnet/rest-api/general-endpoints#check-server-time "Direct link to Check server time")
...
### Exchange information[​](/docs/binance-spot-api-docs/testnet/rest-api/general-endpoints#exchange-information "Direct link to Exchange information")
...
**Notes:**
  ...
  * If `permissions` parameter not provided, all symbols that have either `SPOT`, `MARGIN`, or `LEVERAGED` permission will be exposed. 
    * To display symbols with any permission you need to specify them explicitly in `permissions`: (e.g. `["SPOT","MARGIN",...]`.). See [Account and Symbol Permissions](/docs/binance-spot-api-docs/testnet/enums#account-and-symbol-permissions) for the full list.
...
### Test connectivity[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/general-endpoints#test-connectivity "Test connectivity的直接链接")
...
### Check server time[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/general-endpoints#check-server-time "Check server time的直接链接")
...
### Exchange information[​](/docs/zh-CN/binance-spot-api-docs/testnet/rest-api/general-endpoints#exchange-information "Exchange information的直接链接")
...
**Notes:**
  ...
  * `permissions` can support single or multiple values (e.g. `SPOT`, `["MARGIN","LEVERAGED"]`). This cannot be used in combination with `symbol` or `symbols`.
  * If `permissions` parameter not provided, all symbols that have either `SPOT`, `MARGIN`, or `LEVERAGED` permission will be exposed. 
    * To display symbols with any permission you need to specify them explicitly in `permissions`: (e.g. `["SPOT","MARGIN",...]`.). See [Account and Symbol Permissions](/docs/zh-CN/binance-spot-api-docs/testnet/enums#account-and-symbol-permissions) for the full list.
