...
api_type: Trading
updated_at: 2026-09-24 18:46:48.801379
---
...
This endpoint allows you to amend more than one open order in a single request.
  ...
  * A maximum of 5 orders (option), 20 orders (inverse), 20 orders (linear), 10 orders (spot) can be amended per request.
...
該接口支持批量修改委託單
  ...
  * 最多支持單個請求中修改, 期權: 5個訂單, 反向合約: 20個訂單, 正向合約: 20个訂單, 現貨: 10個訂單.
