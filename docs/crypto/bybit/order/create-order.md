...
api_type: Trading
updated_at: 2026-07-02 19:20:00.143693
---
...
rpiTakerAccess| false| boolean| `true`: Your order will be eligible to match against RPI quotes, `false`: not eligible. Please read the [RPI taker feature](https://announcements.bybit.com/en/article/rpi-liquidity-now-available-to-api-taker-orders-bltb943887bfa4c4d17/) Note: This feature is currently in a gradual rollout phase and will be fully available on 12 June.  
...
rpiTakerAccess| false| boolean| `true`: 您的訂單可以和RPI報價撮合, `false`: 不能和RPI報價撮合. 請先仔細閱讀[RPI Taker](https://announcements.bybit.com/en/article/rpi-liquidity-now-available-to-api-taker-orders-bltb943887bfa4c4d17/)的特性 提示: 該特性還在灰度中, 6月12日全量  
