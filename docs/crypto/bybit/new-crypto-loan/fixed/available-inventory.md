---
exchange: bybit
source_url: https://bybit-exchange.github.io/docs/v5/new-crypto-loan/fixed/available-inventory
api_type: REST
updated_at: 2026-08-29 18:39:25.721374
---
...
> strategyType| string| `PARTIAL`: Allow partial fill; `FULL`: Full fill only. Default: `"PARTIAL"`  
...
> strategyType| string| `PARTIAL`: 允許部分成交（預設）；`FULL`: 僅允許全部成交  
