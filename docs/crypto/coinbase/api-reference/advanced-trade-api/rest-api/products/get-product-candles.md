...
updated_at: 2026-09-07 18:58:08.945975
---
...
Get Product Candles
    ...
    fetch('https://api.coinbase.com/api/v3/brokerage/products/{product_id}/candles', options)
      .then(res => res.json())
    ...
    curl_setopt_array($curl, [
      CURLOPT_URL => "https://api.coinbase.com/api/v3/brokerage/products/{product_id}/candles",
    ...
    HttpResponse<String> response = Unirest.get("https://api.coinbase.com/api/v3/brokerage/products/{product_id}/candles")
      .header("Authorization", "Bearer <token>")
      .asString();
    ...
    url = URI("https://api.coinbase.com/api/v3/brokerage/products/{product_id}/candles")
...
Get Market Trades
    ...
    fetch('https://api.coinbase.com/api/v3/brokerage/products/{product_id}/ticker', options)
      .then(res => res.json())
      .then(res => console.log(res))
      .catch(err => console.error(err));
    ...
    curl_setopt_array($curl, [
      CURLOPT_URL => "https://api.coinbase.com/api/v3/brokerage/products/{product_id}/ticker",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
    ...
    HttpResponse<String> response = Unirest.get("https://api.coinbase.com/api/v3/brokerage/products/{product_id}/ticker")
      .header("Authorization", "Bearer <token>")
      .asString();
    ...
    url = URI("https://api.coinbase.com/api/v3/brokerage/products/{product_id}/ticker")
