...
api_type: Account
updated_at: 2026-07-26 19:05:41.253976
---
...
International Derivatives (INTX, deprecated)
...
Opt In or Out of Multi Asset Collateral
    ...
    fetch('https://api.coinbase.com/api/v3/brokerage/intx/multi_asset_collateral', options)  
      .then(res => res.json())  
      .then(res => console.A JWT signed using your CDP API Key Secret, encoded in base64. Refer to the [Creating API Keys](/coinbase-app/authentication-authorization/api-key-authentication) section of our Coinbase App Authentication docs for information on how to generate your Bearer Token.
