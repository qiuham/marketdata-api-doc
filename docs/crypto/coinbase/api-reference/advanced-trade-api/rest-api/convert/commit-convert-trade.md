...
api_type: Trading
updated_at: 2026-08-30 18:53:00.280158
---
...
Commits a convert trade with a specified trade id, source account, and target account
    ...
    curl_setopt_array($curl, [
      ...
      CURLOPT_CUSTOMREQUEST => "POST",
      CURLOPT_POSTFIELDS => json_encode([
        'from_account' => Content-Type: application/json"
      ],
    ]);
      ...
      "trade": {
        ...
        "source": {
          ...
          "paypal": {
            ...
            "braintree_customer_id": "<string>'<string>',
        'to_account' => '<string>'
      ]),
      CURLOPT_HTTPHEADER => [
        "Authorization: Bearer <token>",
    ...
    curl --request POST \
      --url https://api.coinbase.com/api/v3/brokerage/convert/trade/{trade_id} \
      --header 'Authorization: Bearer <token>' \
      --header 'Content-Type: application/json'<string>",
            "customers_bank_account_id": "<string>",
            "currency": "<string>"
          },
          "ideal": {
            ...
            "account_settlements": [
              {
                ...
                "existing_hold_id": "<string>"<string>",
            "phone_number": "<string>",
            "currency": "<string>",
            "open_banking_details": {
              "true_layer_bank_provider_id": "<string>",
