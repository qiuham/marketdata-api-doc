---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/coin-margined-futures/user-data-streams/Event-STRATEGY-UPDATE
api_type: REST
updated_at: 2026-01-15T23:40:17.031276
---
...
## 事件描述[​](/docs/zh-CN/derivatives/coin-margined-futures/user-data-streams/Event-STRATEGY-UPDATE#事件描述 "事件描述的直接链接")
...
## 事件类型[​](/docs/zh-CN/derivatives/coin-margined-futures/user-data-streams/Event-STRATEGY-UPDATE#事件类型 "事件类型的直接链接")

`STRATEGY_UPDATE`

## 响应示例[​](/docs/zh-CN/derivatives/coin-margined-futures/user-data-streams/Event-STRATEGY-UPDATE#响应示例 "响应示例的直接链接")
