---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/usds-margined-futures/trade/rest-api/New-Algo-Order
api_type: Trading
updated_at: 2026-01-15T23:47:22.599654
---
...
## 接口描述[​](/docs/zh-CN/derivatives/usds-margined-futures/trade/rest-api/New-Algo-Order#接口描述 "接口描述的直接链接")

下条件单

## HTTP请求[​](/docs/zh-CN/derivatives/usds-margined-futures/trade/rest-api/New-Algo-Order#http请求 "HTTP请求的直接链接")

POST `/fapi/v1/algoOrder`

## 请求权重[​](/docs/zh-CN/derivatives/usds-margined-futures/trade/rest-api/New-Algo-Order#请求权重 "请求权重的直接链接")

IP rate limit(x-mbx-used-weight-1m)为0

## 请求参数[​](/docs/zh-CN/derivatives/usds-margined-futures/trade/rest-api/New-Algo-Order#请求参数 "请求参数的直接链接")
...
## 响应示例[​](/docs/zh-CN/derivatives/usds-margined-futures/trade/rest-api/New-Algo-Order#响应示例 "响应示例的直接链接")
