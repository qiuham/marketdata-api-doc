---
exchange: binance
source_url: https://developers.binance.com/docs/derivatives/options-trading/market-maker-block-trade/Extend-Block-Trade-Order
api_type: Market Data
updated_at: 2026-01-15T23:41:52.139888
---
...
## API Description[​](/docs/zh-CN/derivatives/options-trading/market-maker-block-trade/Extend-Block-Trade-Order#api-description "API Description的直接链接")

Extends a block trade expire time by 30 mins from the current time.

## HTTP Request[​](/docs/zh-CN/derivatives/options-trading/market-maker-block-trade/Extend-Block-Trade-Order#http-request "HTTP Request的直接链接")

PUT `/eapi/v1/block/order/create` 

## Request Weight[​](/docs/zh-CN/derivatives/options-trading/market-maker-block-trade/Extend-Block-Trade-Order#request-weight "Request Weight的直接链接")

**5**

## Request Parameters[​](/docs/zh-CN/derivatives/options-trading/market-maker-block-trade/Extend-Block-Trade-Order#request-parameters "Request Parameters的直接链接")
...
## Response Example[​](/docs/zh-CN/derivatives/options-trading/market-maker-block-trade/Extend-Block-Trade-Order#response-example "Response Example的直接链接")
