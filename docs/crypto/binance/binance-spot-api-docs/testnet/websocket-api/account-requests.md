---
exchange: binance
source_url: https://developers.binance.com/docs/binance-spot-api-docs/testnet/websocket-api/account-requests
api_type: WebSocket
updated_at: 2026-01-15T23:36:48.827067
---

# Account requests

### Account information (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-information-user_data "Direct link to Account information \(USER_DATA\)")
...
### Query order (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-user_data "Direct link to Query order \(USER_DATA\)")
...
### Current open orders (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#current-open-orders-user_data "Direct link to Current open orders \(USER_DATA\)")
...
### Account order history (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-order-history-user_data "Direct link to Account order history \(USER_DATA\)")
...
### Query Order list (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-list-user_data "Direct link to Query Order list \(USER_DATA\)")
...
### Current open order lists (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#current-open-order-lists-user_data "Direct link to Current open order lists \(USER_DATA\)")
...
### Account order list history (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-order-list-history-user_data "Direct link to Account order list history \(USER_DATA\)")
...
### Account trade history (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-trade-history-user_data "Direct link to Account trade history \(USER_DATA\)")
...
### Account unfilled order count (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-unfilled-order-count-user_data "Direct link to Account unfilled order count \(USER_DATA\)")
...
### Account prevented matches (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-prevented-matches-user_data "Direct link to Account prevented matches \(USER_DATA\)")
...
### Account allocations (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-allocations-user_data "Direct link to Account allocations \(USER_DATA\)")
...
### Account Commission Rates (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#account-commission-rates-user_data "Direct link to Account Commission Rates \(USER_DATA\)")
...
### Query Order Amendments (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-amendments-user_data "Direct link to Query Order Amendments \(USER_DATA\)")
...
### Query Relevant Filters (USER_DATA)[​](/docs/binance-spot-api-docs/testnet/websocket-api/account-requests#query-relevant-filters-user_data "Direct link to Query Relevant Filters \(USER_DATA\)")
...
### Account information (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-information-user_data "Account information \(USER_DATA\)的直接链接")
...
### Query order (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-user_data "Query order \(USER_DATA\)的直�接链接")
...
### Current open orders (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#current-open-orders-user_data "Current open orders \(USER_DATA\)的直接链接")
...
If you need to continuously monitor order status updates, please consider using WebSocket Streams:
  ...
  * [`userDataStream.start`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#user-data-stream-requests) request
  * [`executionReport`](/docs/zh-CN/binance-spot-api-docs/testnet/user-data-stream#order-update) user data stream event
...
Status reports for open orders are identical to [`order.status`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-user_data).
...
### Account order history (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-order-history-user_data "Account order history \(USER_DATA\)的直接链接")
...
Status reports for orders are identical to [`order.status`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-user_data).
...
### Query Order list (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-list-user_data "Query Order list \(USER_DATA\)的直接链接")
...
For execution status of individual orders, use [`order.status`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-user_data).
...
### Current open order lists (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#current-open-order-lists-user_data "Current open order lists \(USER_DATA\)的直接链接")
...
### Account order list history (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-order-list-history-user_data "Account order list history \(USER_DATA\)的直接链接")
...
Status reports for order lists are identical to [`orderList.status`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-list-user_data).
...
### Account trade history (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-trade-history-user_data "Account trade history \(USER_DATA\)的直接链接")
...
### Account unfilled order count (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-unfilled-order-count-user_data "Account unfilled order count \(USER_DATA\)的直接链接")
...
### Account prevented matches (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-prevented-matches-user_data "Account prevented matches \(USER_DATA\)的直接链接")
...
### Account allocations (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-allocations-user_data "Account allocations \(USER_DATA\)的直接链接")
...
### Account Commission Rates (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#account-commission-rates-user_data "Account Commission Rates \(USER_DATA\)的直接链接")
...
### Query Order Amendments (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-order-amendments-user_data "Query Order Amendments \(USER_DATA\)的直接链接")
...
### Query Relevant Filters (USER_DATA)[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/account-requests#query-relevant-filters-user_data "Query Relevant Filters \(USER_DATA\)的直接链接")
...
Retrieves the list of [filters](/docs/zh-CN/binance-spot-api-docs/testnet/filters) relevant to an account on a given symbol. This is the only method that shows if an account has [`MAX_ASSET`](/docs/zh-CN/binance-spot-api-docs/testnet/filters#max_asset) filters applied to it.
