---
exchange: binance
source_url: https://developers.binance.com/docs/binance-spot-api-docs/testnet/websocket-api/market-data-requests
api_type: WebSocket
updated_at: 2026-01-15T23:36:55.897516
---
...
---|---|---|---  
`symbol`| STRING| YES|   
`interval`| ENUM| YES| See [`klines`](/docs/binance-spot-api-docs/testnet/websocket-api/market-data-requests#kline-intervals)  
`startTime`| LONG| NO|   
`endTime`| LONG| NO|   
`timeZone`| STRING| NO| Default: 0 (UTC)  
`limit`| INT| NO| Default: 500; Maximum: 1000  
...
If you need to continuously monitor trading statistics, please consider using WebSocket Streams:
  ...
  * [`<symbol>@ticker`](/docs/binance-spot-api-docs/testnet/web-socket-streams#individual-symbol-ticker-streams)
...
### Order book[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#order-book "Order book的直接链接")
...
If you need to continuously monitor order book updates, please consider using WebSocket Streams:
  ...
  * [`<symbol>@depth<levels>`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#partial-book-depth-streams)
  * [`<symbol>@depth`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#diff-depth-stream)



You can use `depth` request together with `<symbol>@depth` streams to [maintain a local order book](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#how-to-manage-a-local-order-book-correctly).
...
### Recent trades[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#recent-trades "Recent trades的直接链接")
...
If you need access to real-time trading activity, please consider using WebSocket Streams:
  ...
  * [`<symbol>@trade`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#trade-streams)
...
### Historical trades[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#historical-trades "Historical trades的直接链接")
...
### Aggregate trades[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#aggregate-trades "Aggregate trades的直接链接")
...
If you need access to real-time trading activity, please consider using WebSocket Streams:
  ...
  * [`<symbol>@aggTrade`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#aggregate-trade-streams)
...
### Klines[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#klines "Klines的直接链接")
...
If you need access to real-time kline updates, please consider using WebSocket Streams:
  ...
  * [`<symbol>@kline_<interval>`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#klinecandlestick-streams)
...
### UI Klines[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#ui-klines "UI Klines的直接链接")
...
This request is similar to [`klines`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#klines), having the same parameters and response. `uiKlines` return modified kline data, optimized for presentation of candlestick charts.
...
---|---|---|---  
`symbol`| STRING| YES|   
`interval`| ENUM| YES| See [`klines`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#kline-intervals)  
`startTime`| LONG| NO|   
`endTime`| LONG| NO|   
`timeZone`| STRING| NO| Default: 0 (UTC)  
`limit`| INT| NO| Default: 500; Maximum: 1000  
...
### Current average price[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#current-average-price "Current average price的直接链接")
...
### 24hr ticker price change statistics[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#24hr-ticker-price-change-statistics "24hr ticker price change statistics的直接链接")
...
If you need to continuously monitor trading statistics, please consider using WebSocket Streams:
  ...
  * [`<symbol>@ticker`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#individual-symbol-ticker-streams)
  * [`<symbol>@miniTicker`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#individual-symbol-mini-ticker-stream) or [`!miniTicker@arr`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#all-market-mini-tickers-stream)



If you need different window sizes, use the [`ticker`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#rolling-window-price-change-statistics) request.
...
### Trading Day Ticker[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#trading-day-ticker "Trading Day Ticker的直接链接")
...
### Rolling window price change statistics[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#rolling-window-price-change-statistics "Rolling window price change statistics的直接链接")
...
This request is similar to [`ticker.24hr`](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#24hr-ticker-price-change-statistics), but statistics are computed on demand using the arbitrary window you specify.
...
If you need to continuously monitor trading statistics, please consider using WebSocket Streams:
  ...
  * [`<symbol>@ticker_<window_size>`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#individual-symbol-rolling-window-statistics-streams) or [`!ticker_<window-size>@arr`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#all-market-rolling-window-statistics-streams)
...
### Symbol price ticker[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#symbol-price-ticker "Symbol price ticker的直接链接")
...
### Symbol order book ticker[​](/docs/zh-CN/binance-spot-api-docs/testnet/websocket-api/market-data-requests#symbol-order-book-ticker "Symbol order book ticker的直接链接")
...
If you need access to real-time order book ticker updates, please consider using WebSocket Streams:
  ...
  * [`<symbol>@bookTicker`](/docs/zh-CN/binance-spot-api-docs/testnet/web-socket-streams#individual-symbol-book-ticker-streams)
