...
id: zhongtai-xtp-2098308313518227457
title: 错误代码速查表
doc_id: 2098308313518227457
doc_category: 其他帮助文档
source_url: 'https://xtp.zts.com.cn/jeecg-boot/xtp/tree/getTreeData?id=2098308313518227457'
...
[上交所拒单原因错误代码查找链接](https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.sse.com.cn%2Fservices%2Ftradingtech%2Fdata%2Fc%2F10821679%2Ffiles%2F2903c0e2ce1e4da9a78af8879aff99cc.xlsx&wdOrigin=BROWSELINK)                          [深交所拒单原因错误代码查找链接](https://www.szse.cn/marketServices/technicalservice/interface/P020240809670217642854.pdf)
...
|	10200103    	|	Failed to bind UDP local port	|	用户API绑定UDP端口失败	|
|	10200104    	|	Failed to alloc UDP session.	|	用户API建立UDP组播失败	|
|	10200105    	|		|	用户设置的UDPBufferSize太大或者太小	|
...
|	10200302    	|		|	发送数据失败	|
|	10200303    	|	invalid exchange type. 	|	订阅或取消订阅时，请求参数与实际不匹配，通常为交易所不支持	|
...
|	11000048	|	Login User Account invalid or not support. 	|	不支持的账户类型		|
|	11000049	|	Login Failed,user is in login black list. 	|	用户名已被加入登录黑名单，禁止登录	|
...
|	11000318	|	New orders for ETF subscription and redemption are not allowed to cancel! 	|	ETF申购和赎回的新订单不允许撤销	|
...
|	11000335	|	Both center user not allow etf physical creation redemption!	|	双中心用户不允许做ETF全实物申赎	|
...
|	11000572	|	Security account has no main board register right!	|	证券账户没有注册制股票权限	|
|	11000573	|	Security account has no delisting convert bond buy right!	|	证券账户没有买入退市整理期可转债权限	|
|	11000580	|	Security account has no technology board tech growth tier right!	|	证券账户没有科创板科创成长层权限	|
...
|   11000931    |   Credit stk sl T0 return trade check failed!  |  两融T0回转交易校验失败！  |
...
|	11011154	|	Invalid ena_sz config in checking rule 45.	|	 rule45深交所风控指标配置无效。	|
|	11011155	|	Invalid ena_sh config in checking rule 45.	|	rule45上交所风控指标配置无效。	|
|	11011156	|	Invalid ord_unit_time config in checking rule 45.	|	 rule45风控指标配置统计时间段无效。	|
|	11011157	|	Invalid unit_time_sz config in checking rule 45.	|	rule45深交所风控指标配置次数无效。	|
|	11011158	|	Invalid unit_time_sh config in checking rule 45.	|	rule45上交所风控指标配置次数无效。	|
|	11011159	|	Invalid ena_sz config in checking rule 46.	|	rule46深交所风控指标配置无效。		|
|	11011160	|	Invalid ena_sh config in checking rule 46.	|	rule46上交所风控指标配置无效。		|
|	11011161	|	Invalid cancel_per_sz config in checking rule 46.	|	rule46深交所风控指标配置百分比无效。	|
|	11011162	|	Invalid cancel_ord_times_sz config in checking rule 46.	|	rule46深交所风控指标配置次数无效。	|
|	11011163	|	Invalid cancel_per_sh config in checking rule 46.	|	rule46上交所风控指标配置百分比无效。	|
|	11011164	|	Invalid cancel_ord_times_sh config in checking rule 46.	|	rule46上交所风控指标配置次数无效。	|
|	11011165	|	Invalid ena_sz config in checking rule 47.	|	rule47深交所风控指标配置无效。	    |
|	11011166	|	Invalid ena_sh config in checking rule 47.	|	rule47上交所风控指标配置无效。		|
|	11011167	|	Invalid unit_time config in checking rule 47.	|	rule47风控指标配置统计时间段无效。		    |
|	11011168	|	Invalid unit_time_sz config in checking rule 47.	|	rule47深交所风控指标配置次数无效。		|
|	11011169	|	Invalid unit_time_sh config in checking rule 47.	|	rule47上交所风控指标配置次数无效。		|
|	11011170	|	Invalid ena_sz config in checking rule 48.	|	rule48深交所风控指标配置无效。		|
|	11011171	|	Invalid ena_sh config in checking rule 48.	|	rule48上交所风控指标配置无效。		|
|	11011172	|	Invalid times_sz config in checking rule 48.	|	rule48深交所风控指标配置次数无效。		|
|	11011173	|	Invalid times_sh config in checking rule 48.	|	rule48上交所风控指标配置次数无效。		|
...
|	11011244    |	Failed to check risk rule 44.Order amount is lower than the minimum limit.	|	风控指标rule44检查失败。	|
|	11011245	|	Failed to check risk rule 45 sz.    |	风控指标rule45深交所检查失败。	    |
|	11011246	|	Failed to check risk rule 45 sh.	|	风控指标rule45上交所检查失败。	    |
|	11011247	|	Failed to check risk rule 46 sz.	|	风控指标rule46深交所检查失败。	    |
|	11011248	|	Failed to check risk rule 46 sh.	|	风控指标rule46上交所检查失败。	    |
|	11011249	|	Failed to check risk rule 47 sz.	|	风控指标rule47深交所检查失败。	    |
|	11011250	|	Failed to check risk rule 47 sh.	|	风控指标rule47上交所检查失败。	    |
|	11011251	|	Failed to check risk rule 48 sz.	|	风控指标rule48深交所检查失败。	    |
|	11011252	|	Failed to check risk rule 48 sh.	|	风控指标rule48上交所检查失败。      |
...
|   11011330    |   Enter rule 27 breaker 2nd sz.  |  入风控指标rule27 2nd sz 熔断。   |
...
|	11113025	|	 Set Prefix Cache Failed	|	 缓存prefix失败
|	11114000	|	 exchange error code（上交所流式报盘错误码）	|	 交易所拒单，为上交所返回；具体可以参考上交所文档，链接里http://www.sse.com.cn/services/tradingtech/data/ 找交易网关Binary接口规格说明书里的最新的错误代码表	|
|	11114001	|	 Allocate request message memory failed	|	 内存池中内存分配失败
|	11114002	|	 Invalid new Order request	|	 无效新订单
|	11114003	|	 Invalid cancel order request	|	 无效撤单
|	11114004	|	 System module loading failed	|	 模块加载失败
|	11114005	|	 Receice binary message from TDGW failed	|	 从TDGW接受消息失败
|	11114006	|	 Send binary message to TDGW failed	|	 发送消息到TDGW失败
|	11114007	|	 Offer config error	|	 配置文件错误
|	11114008	|	 Start platform failed	|	 启动交易平台失败
|	11114009	|	 Stop platform failed	|	 停止交易平台失败
|	11114010	|	 Start heartbeat thread failed	|	 启动心跳机制失败
|	11114011	|	 Stop heartbeat thread failed	|	 停止心跳机制失败
|	11114012	|	 Start receive thread failed	|	 接受线程启动失败
|	11114013	|	 Start send thread failed	|	 发送线程启动失败
|	11114014	|	 Connect to TDGW failed	|	 无法连接到TDGW
|	11114015	|	 Binary message inner error, Check length error	|	 binary消息体长度检测错误
|	11114016	|	 Binary message inner error, Check sum error	|	 binary消息体校验错误
|	11114017	|	 Binary message size too large	|	 binary消息体过大
|	11114018	|	 Unsupport binary message	|	 当前不支持的binary消息体
|	11114019	|	 Invalid order status	|	 无效的订单状态
|	11114020	|	 Invalid order price type	|	 无效的价格类型
|	11114021	|	 Invalid side type	|	 无效的买卖类型
|	11114022	|	 Exchange id error	|	 错误的交易所编号
|	11114023	|	 Business reject	|	 TDGW的业务拒绝消息
|	11114024	|	 TDGW disconnected	|	 TDGW的连接断开
|	11114025	|	 Enter daemon mode failed	|	 进入守护进程模式失败
|	11114026	|	 Invalid Platform State	|	 无效的平台状态（盘前，交易中，盘中，盘后）
|	11114027	|	 Fast buffer malloc memory failed fast buffer	|	 内存分配失败
|	11114028	|	 Invalid market order	|	 无效的市场订单
|	11114029	|	 No cache orig new order	|	 没有缓存原始订单
|	11114030	|	 TDGW Platform have closed	|	 交易平台关闭
|	11114031	|	 Encode TDGW message fail 	|	binary消息体编码失败
|	11114032	|	 Duplicate ID in the new order prepare cache	|	 缓存中的订单重复
|	11114033	|	 Duplicate new order id	|	 重复的新订单号
|	11114034	|	 Duplicate cancel order id	|	 重复的撤单号
|	11114035	|	 Original new order is not exist	|	 原始新订单不存在
|	11114036	|	 New order cannot be canceled in prepare cache	|	 缓存中的原始新订单无法被撤销
|	11114037	|	 New order in prepare cache send timeout	|	 缓存中的新订单发送超时
|	11114038	|	 Order cache flush into disk fail	|	 缓存中的订单写入硬盘失败
|	11114039	|	 Invalid offer type in new order	|	 无效的订单类型
|	11114040	|	 Init info from database fail	|	 数据库初始化失败
|	11114041	|	 Find xtp id by ogw id fail	|	 找不到ogw id对应的xtp id
|	11114042	|	 Stock suspension	|	 股票停牌
|	11114043	|	 Store precache order into disk fail	|	 缓存中的订单写入硬盘失败
|	11114044	|	 Cancel order fail by TDGW	|	 TDGW拒绝撤单
|	11114045	|	 TDGW platform is not open	|	 TDGW平台没开放
|	11114046	|	 Test live order	|	 测试新订单
|	11114047	|	 Scoped mark init fail	|	 打点模块初始化失败
|	11114048	|	 Invalid appid in cancel order	|	 无效的撤单APP ID
|	11114049	|	 Decode TDGW message fail	|	 解码TDGW消息失败
|	11114050	|	 Append msg into queue fail	|	 消息加入队列失败
|	11114051	|	 Init etf sequence dat fail	|	 插入ETF序列数据失败
|	11114052	|	 Lost the order for system error	|	 该订单未发送给TDGW
|	11114053	|	 Start orderstat exec fail	|	 开始订单统计模块失败
|	11114054	|	 Stop orderstat exec fail	|	 停止订单统计模块失败
|	11114055	|	 TDGW of the pbu id not found	|	 PBUID未找到
|	11114056	|	 Platform not be restored yet	|	 平台尚未恢复
|	11114057	|	 Exec id filter insertion fail	|	 Exec id插入失败
|	11114058	|	 Exec report index sync fail	|	 执行报告序号同步失败
|	11114059	|	 Invalid Position Effect	|	 无效的开平标志
|	11114060	|	 Invalid Business Type	|	 无效的业务类型
|	11114061	|	 Invalid Order Qty	|	 无效的委托数量
...
|	11115009    	|   	Can't get cancel order pack! 	|	撤单获取失败
...
|	11115104	|	Reg release newOrder confirm pack failed!	|	注册订单确认释放服务失败	|
|	11115105	|		|	注册查询XtpID服务失败	|
|	11115200	|	Invalid DB login string!	|	数据库连接语句错误	|
|	11115201	|	Execute Sql string failed!	|	Sql语句执行失败	|
|	11115202	|	DB login failed!	|	数据库登录失败	|
|	11115203	|		|	调用add_push_data失败	|
|	11115204	|		|	重复的xtpid	|
|	11115205   	|	Repeated order event!  |	重复的order_event
|	11115206    |	Repeated order report! |	重复的report
...
|	11115308	|	Total Bond Inv Rate Error!	|	投资于债券的投资总额的资产净值占比	|
|	11115309	|	Unsupported security type!	|	不支持的证券类型	|
|	11115400	|	Fund Hold Rate Error!	|	非货币基金持有比例的资产净值占比	|
|	11115401	|	Fund Inv Rate Error!	|	单只非货币基金股票投资额的资产净值占比	|
|	11115402	|	Money Fund Hold Rate Error!	|	货币基金持有比例的资产净值占比	|
|	11115403	|	Money Fund Inv Rate Error!	|	单只货币基金投资额的资产净值占比	|
|	11115404	|	Money Fund Scale Rate Error!	|	货币基金的基金总规模占比	|
|	11115405	|	Expiration Date Error!	|	距离届满日的天数	|
|	11115406	|	Invalid Fund Account!	|	错误的资金账号	|
|	11115407	|	Invalid Security Position!	|	错误的持仓信息	|
|	11115408	|	Already Reach Open Line!	|	已经达到平仓线，不允许买入	|
|	11115409	|	This Stock Not In White List!	|	不在白名单内的证券	|
|	11115410	|	Can not find white list!	|	该资金账号没有白名单	|
|	11115411	|	This Stock In Blacklist!	|	该证券是黑名单证券	|
|	11115412	|	Can not load security config!	|	获取不到证券信息	|
|	11115413	|	Can not find security in DB data!	|	数据库中没有这个证券信息	|
|	11115500	|	Can not find fund position data!	|	找不到资金账号持仓数据	|
|	11115501	|	Preopen Security Inv Rate Error!	|	盘前风控单只股票投资额超标	|
|	11115502	|	Preopen Total Pos Error!	|	盘前风控单只股票总股本超标	|
|	11115503	|	Preopen Circ Pos Error!	|	盘前风控单只股票流通股本超标	|
|	11115504	|	Invalid Security Status!	|	非法的股票状态（ST、*ST等）	|
|	11115505	|	Margin Trade Is Banned! 	|	不允许融资买入	|
|	11115506	|	Short Sell Is Banned! 	|	不允许融券卖出	|
|	11115507	|	Total Industry Inv Rate Error! 	|    行业集中度(超出单行业投资总额的限制)   	|
|	11115600	|	GEM Total Capital Rate Error	|    可投资股票总股本占比            -- 创业板	|
|	11115601	|	GEM Circ Capital Rate Error	 |	可投资股票流通股占比            -- 创业板	|
|	11115602	|	GEM Security Inv Rate Error	 |	单只股票投资额的资产净值占比    -- 创业板	|
|	11115603	|	Tech_Gem Total Capital Rate Error	 |	  可投资股票总股本占比            -- 科创板以及创业板	|
|	11115604	|	Tech_Gem Circ Capital Rate Error	 |    可投资股票流通股占比            -- 科创板以及创业板	|
|	11115605	|	Tech_Gem Security Inv Rate Error! 	 |    单只股票投资额的资产净值占比    -- 科创板以及创业板	|
|	11115606	|	Tech_Gem Total Inv Rate Error! 	|    科创板及创业板投资总金额        -- 科创板以及创业板	|
|	11115607	|	ETF Purchase not support! 	|    不支持ETF申赎	|
|	11115608	|	No IPO Right! 	|    无新股申购权限	|
|	11115609	|	No AllotMent Right! 	|    无配股配债权限	|
|	11115610	|	 Failed to pass admin review!  (Admin Failed To Pass The Audit!) 	 |	订单管理人审核未通过	|
|	11115611	|	 Failed to pass trader review!  (Trader Failed To Pass The Audit!) 	 |	订单交易员审核未通过	|
|	11115612	|	 Failed to pass Auto&T review!  (Auto And Trader Failed To Pass The Audit!) 	 |	自动审核未通过,订单交易员审核未通过	|
|	11115613	|	 Failed to pass auto review!  (Auto	Failed To Pass The Audit!) 	 |	自动审核未通过,订单交易员审核通过	|
|	11115614	|	 Failed to check riskx rule1. 	 |    （Mom Anti Knock Error!) 	 |	防对敲失败 riskx风控条例1触发	|
|	11115615	|	 Failed to check riskx rule2. 	 |    （Mom Reverse Trade Error!) 	 |	大M反向交易-在途失败 riskx风控条例2触发	|
|	11115616	|	 Failed to check riskx rule3. 	 |    （Mom Fundacc No Buy Right!!) 	 |	MOM账户不允许开仓 riskx风控条例3触发	|
|	11115617	|	 Failed to check riskx rule4. 	 |    （Mom All Day Reverse Trade Error!) 	 |	大M反向交易-全天失败 riskx风控条例4触发	|
|	11115618	|	 Failed to check riskx rule5. 	 |    （Asset Unit Reverse Trade Error!) 	 |	小m反向交易-在途失败 riskx风控条例5触发	|
|	11115619	|	 Failed to check riskx rule6. 	 |    （Asset Unit All Day Reverse Trade Error!) 	 |	小m反向交易-全天失败 riskx风控条例6触发	|
|	11115620	|	 Failed to check riskx rule7. 	 |    （Asset Unit Self Trade Error!) 	 |	小m自成交失败 riskx风控条例7触发	|
|	11115621	|	 Failed to check riskx rule8or9. |    （Fund Acc Stock In Reverse Trade Black List,Forbid Trade!) 	 |	股票在交易黑名单 riskx风控条例8,、9触发	|
|	11115622	|	 Failed to check riskx rule10. 	 |    （Cancel Order Per Exceed,Forbid Cancel Ordr!) 	 |	MOM账户不允许撤单 riskx风控条例10触发	|
...
|	11200006	|	api have no right 	|	API无权限
|	11200007	|	api request frequently	|	API请求太频繁
|	11200008	|	not find resource	|	 找不到资源
|	11200009	|	api request param error	|	 API传入参数错误
|	11200010	|	user not exist	|	 用户不存在
|	11200011	|	password error	|	 用户密码错误
|	11200012	|	unsupport api	|	 不支持的API
|	11200013	|	user in blacklist	|	 用户在黑名单中
